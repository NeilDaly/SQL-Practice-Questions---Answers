/* 
    In the job_postings_fact table:
     calculate the total sum of the average yearly salary (salary_year_avg) for all job postings that are marked as fully remote
     divide it by the total count of salary_year_avg. 
